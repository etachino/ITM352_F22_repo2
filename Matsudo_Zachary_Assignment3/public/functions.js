...
// Taken from A3 Code examples and Professor Port A3 examples repo
...
function nav_bar(this_product_key, products_data) {
    ...
    for (let products_key in products_data) {
        ...
        document.write(`<li><a href="./products_page.html?products_key=${products_key}">${products_key}</a></li>`);
    }
}