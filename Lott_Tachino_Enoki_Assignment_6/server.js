/*Assignment 6. Created by DANIEL LOTT, ERIN TACHINO, AND JUSTIN ENOKI added to A3 in itm352, created admin page and dynamic pricing.
    ...
    for (catagory_key in shopping_cart) {
        for (i = 0; i < shopping_cart[catagory_key].length; i++) {
            ...
            if (qty > 0) {
                ...
                // If an item was not found and processed earlier in the loop, check if the 'adminIn' cookie is set to "true" for administrative access.
                salesRecord = {
                    // Create a salesRecord object with the properties item_id, Customer_Id, Quantity_sold, and date
                    item_id: Item_Id,
